...
<base href="../../" />
		...
		<link rel="canonical" href="http://preview.keenthemes.comauthentication/email/reset-password.html" />
		...
		<div class="d-flex flex-column flex-root" id="kt_app_root">
			...
			<div class="d-flex flex-column flex-column-fluid">
				...
				<div class="bg-body d-flex flex-column-auto justify-content-cenrer align-items-start gap-2 gap-lg-4 py-4 px-10 overflow-auto" id="kt_app_header_nav">
					...
					<a href="authentication/email/reset-password.html" class="btn btn-icon flex-column btn-text-gray-500 btn-icon-gray-300 btn-active-text-gray-700 btn-active-icon-gray-500 rounded-3 h-60px w-60px h-lg-90px w-lg-90px fw-semibold active bg-light border border-2">
					...
					<a href="authentication/email/reset-password.html?nav=0" class="flex-grow-1 text-end mt-2">

...
if (isset($_SERVER['HTTP_HOST'])) {
    ...
    $config['base_url'] = 'http://localhost/jbm_app/';
}
...
|
*/
$config['encryption_key'] = 'JBM2024XkZ7mQ3nP9wRtYvBsLhCdFgUe';
...
$config['sess_cookie_name'] = 'jbm_session';
...
$config['csrf_token_name'] = 'jbm_csrf_token';
$config['csrf_cookie_name'] = 'jbm_csrf_cookie';
$config['csrf_expire'] = 7200;
$config['csrf_regenerate'] = FALSE; // Disable per-request regeneration so AJAX flows work correctly
